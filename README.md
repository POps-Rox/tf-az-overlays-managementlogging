...
| <a name="input_ampls_subnet_address_prefix"></a> [ampls\_subnet\_address\_prefix](#input\_ampls\_subnet\_address\_prefix) | The address prefix for the subnet to be created for Azure Monitor Private Link Scope. | `list(string)` | `null` | no |
